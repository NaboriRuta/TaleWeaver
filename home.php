...
<body>
    ...
    <main>
        <p>Project Taleweaver is a writer-friendly website designed by three high school students to assist young authors with their stories. 
            <br/> Our goal is to aid writers with helpful writing skills, inspiration, and formatting; all things any creative writer needs.</p>
        <div class="home-grid">
            <div class="part">
                <p>Your Personal Writing Hub</p>
                <button>Dashboard</button>
            </div>
            <div class="part">
                <p>Need some creative writing tips?</p>
                <button onclick="window.location.href='./writing/writing-help.html'">Creative Writing Help</button>
            </div>
            <div class="part">
                <p>Lacking Organization?</p>
                <button onclick="window.location.href='./forms/forms.html'">Visit Our Story Planners</button>
            </div>
        </div>
    </main>
    <footer>
